...
;; AI model via a shell script (lm). It allows for sending a region of text
;; or a custom string to the AI model, and then inserting the output at various
;; locations in the buffer.
;; Make sure that lm is on your PATH before running this function

(defun call-claude ()
  "Function to interact with the Claude AI model."
  (interactive)

  ;; Use 'which' to find the location of the 'lm' command
  (let* ((lm-location (string-trim (shell-command-to-string "which lm"))))
